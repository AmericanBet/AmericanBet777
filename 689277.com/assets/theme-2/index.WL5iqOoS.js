...
function s() {
    ...
    new MutationObserver(e => {
        for (const t of e)
            if (t.type === "childList")
                for (const o of t.addedNodes) o.tagName === "LINK" && o.rel === "modulepreload" && i(o)
    }).observe(document, {
        childList: !0,
        subtree: !0
    });
...
export {
    s as __vite_legacy_guard
};
//# sourceMappingURL=index.WL5iqOoS.js.map